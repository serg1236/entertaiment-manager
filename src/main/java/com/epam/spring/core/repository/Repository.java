...
public class Repository {
    ...
    private  Map<Integer, DiscountStatistic> discountStatistics = new HashMap<Integer, DiscountStatistic>();
    ...
    public Map<Integer, DiscountStatistic> getDiscountStatistics() {
