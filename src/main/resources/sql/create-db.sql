...
ALTER TABLE EVENT_STATISTIC ADD CONSTRAINT FK_EVENT_STATISTIC FOREIGN KEY ( EVENT_ID ) REFERENCES EVENT( ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE TICKET ADD CONSTRAINT FK_TICKET FOREIGN KEY ( OCCASION_ID ) REFERENCES OCCASION( ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE VIP_SEAT ADD CONSTRAINT FK_VIP_SEAT FOREIGN KEY ( AUDITORIUM_ID ) REFERENCES AUDITORIUM( ID ) ON DELETE NO ACTION ON UPDATE NO ACTION;
