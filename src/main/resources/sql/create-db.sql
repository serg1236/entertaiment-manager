...
INSERT INTO EM_USER(NAME, EMAIL, BIRTH_DATE, EM_ROLES, EM_PASSWORD) VALUES('Chuck Norris', 'admin@em.com', to_timestamp('23-APR-1960 06.11.52.000000000 PM','DD-MON-YYYY HH.MI.SS.FF AM'), 'ROLE_BOOKING_MANAGER', '$2a$04$XvyeKLqOUPMipFTf2gfPv./RQjrWyKRWmxPlkehwwhfKVnD8V9gxi');
INSERT INTO EM_USER(NAME, EMAIL, BIRTH_DATE, EM_ROLES, EM_PASSWORD) VALUES('John Doe', 'user@em.com', to_timestamp('22-SEP-1970 06.11.52.000000000 PM','DD-MON-YYYY HH.MI.SS.FF AM'), 'ROLE_REGISTERED_USER', '$2a$04$XvyeKLqOUPMipFTf2gfPv./RQjrWyKRWmxPlkehwwhfKVnD8V9gxi');
